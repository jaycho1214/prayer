...
Map<BibleBook, String> bible_books_korean = {
  ...
  BibleBook.ezra: '에스라기',
  BibleBook.nehemiah: '느헤미야기',
  BibleBook.esther: '에스더기',
  BibleBook.job: '욥기',
  BibleBook.psalms: '시편',
  BibleBook.proverbs: '잠언',
  BibleBook.ecclesiastes: '전도서',
  BibleBook.songOfSongs: '아가',
  BibleBook.isaiah: '이사야서',
  BibleBook.jeremiah: '예레미야서',
  BibleBook.lamentations: '애가',
  BibleBook.ezekiel: '에스겔서',
  BibleBook.daniel: '다니엘서',
  BibleBook.hosea: '호세아서',
  BibleBook.joel: '요엘서',
  BibleBook.amos: '아모스서',
  BibleBook.obadiah: '오바댜서',
  BibleBook.jonah: '요나서',
  BibleBook.micah: '미가서',
  BibleBook.nahum: '나훔서',
  BibleBook.habakkuk: '하박국서',
  BibleBook.zephaniah: '스바냐서',
  BibleBook.haggai: '학개서',
  BibleBook.zechariah: '스가랴서',
  BibleBook.malachi: '말라기서',
